#[doc = "Register `MEIDR` writer"]
pub type W = crate::W<MeidrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn merr0(&mut self) -> Merr0W<MeidrSpec> {
        Merr0W::new(self, 0)
    }
    #[doc = "Bit 1 - Master 1 Access Error"]
    #[inline(always)]
    pub fn merr1(&mut self) -> Merr1W<MeidrSpec> {
        Merr1W::new(self, 1)
    }
    #[doc = "Bit 2 - Master 2 Access Error"]
    #[inline(always)]
    pub fn merr2(&mut self) -> Merr2W<MeidrSpec> {
        Merr2W::new(self, 2)
    }
    #[doc = "Bit 3 - Master 3 Access Error"]
    #[inline(always)]
    pub fn merr3(&mut self) -> Merr3W<MeidrSpec> {
        Merr3W::new(self, 3)
    }
    #[doc = "Bit 4 - Master 4 Access Error"]
    #[inline(always)]
    pub fn merr4(&mut self) -> Merr4W<MeidrSpec> {
        Merr4W::new(self, 4)
    }
    #[doc = "Bit 5 - Master 5 Access Error"]
    #[inline(always)]
    pub fn merr5(&mut self) -> Merr5W<MeidrSpec> {
        Merr5W::new(self, 5)
    }
    #[doc = "Bit 6 - Master 6 Access Error"]
    #[inline(always)]
    pub fn merr6(&mut self) -> Merr6W<MeidrSpec> {
        Merr6W::new(self, 6)
    }
    #[doc = "Bit 7 - Master 7 Access Error"]
    #[inline(always)]
    pub fn merr7(&mut self) -> Merr7W<MeidrSpec> {
        Merr7W::new(self, 7)
    }
    #[doc = "Bit 8 - Master 8 Access Error"]
    #[inline(always)]
    pub fn merr8(&mut self) -> Merr8W<MeidrSpec> {
        Merr8W::new(self, 8)
    }
    #[doc = "Bit 9 - Master 9 Access Error"]
    #[inline(always)]
    pub fn merr9(&mut self) -> Merr9W<MeidrSpec> {
        Merr9W::new(self, 9)
    }
    #[doc = "Bit 10 - Master 10 Access Error"]
    #[inline(always)]
    pub fn merr10(&mut self) -> Merr10W<MeidrSpec> {
        Merr10W::new(self, 10)
    }
    #[doc = "Bit 11 - Master 11 Access Error"]
    #[inline(always)]
    pub fn merr11(&mut self) -> Merr11W<MeidrSpec> {
        Merr11W::new(self, 11)
    }
    #[doc = "Bit 12 - Master 12 Access Error"]
    #[inline(always)]
    pub fn merr12(&mut self) -> Merr12W<MeidrSpec> {
        Merr12W::new(self, 12)
    }
    #[doc = "Bit 13 - Master 13 Access Error"]
    #[inline(always)]
    pub fn merr13(&mut self) -> Merr13W<MeidrSpec> {
        Merr13W::new(self, 13)
    }
    #[doc = "Bit 14 - Master 14 Access Error"]
    #[inline(always)]
    pub fn merr14(&mut self) -> Merr14W<MeidrSpec> {
        Merr14W::new(self, 14)
    }
    #[doc = "Bit 15 - Master 15 Access Error"]
    #[inline(always)]
    pub fn merr15(&mut self) -> Merr15W<MeidrSpec> {
        Merr15W::new(self, 15)
    }
}
#[doc = "Master Error Interrupt Disable Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`meidr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MeidrSpec;
impl crate::RegisterSpec for MeidrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`meidr::W`](W) writer structure"]
impl crate::Writable for MeidrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MEIDR to value 0"]
impl crate::Resettable for MeidrSpec {}
