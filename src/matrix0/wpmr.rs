...
#[doc = "Field `CFGFRZ` reader - "]
pub type CfgfrzR = crate::BitReader;
#[doc = "Field `CFGFRZ` writer - "]
pub type CfgfrzW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Write Protection Key\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u32)]
pub enum Wpkeyselect {
    #[doc = "5062996: Writing any other value in this field aborts the write operation of the WPEN and CFGFRZ bits. Always reads as 0."]
    Passwd = 5062996,
}
...
impl WpkeyR {
    ...
    pub const fn variant(&self) -> Option<Wpkeyselect> {
        match self.bits {
            5062996 => Some(Wpkeyselect::Passwd),
            _ => None,
        }
    }
    #[doc = "Writing any other value in this field aborts the write operation of the WPEN and CFGFRZ bits. Always reads as 0."]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn cfgfrz(&self) -> CfgfrzR {
        CfgfrzR::new(((self.bits >> 7) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn cfgfrz(&mut self) -> CfgfrzW<WpmrSpec> {
        CfgfrzW::new(self, 7)
    }
    #[doc = "Bits 8:31 - Write Protection Key"]
    #[inline(always)]
