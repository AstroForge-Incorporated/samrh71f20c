...
#[doc = "Field `WPCREN` reader - Write Protection Control Register Enable"]
pub type WpcrenR = crate::BitReader;
#[doc = "Field `WPCREN` writer - Write Protection Control Register Enable"]
...
impl WpkeyR {
    ...
    pub const fn variant(&self) -> Option<Wpkeyselect> {
        match self.bits {
            5329744 => Some(Wpkeyselect::Passwd),
            _ => None,
        }
    }
...
impl R {
    ...
    #[doc = "Bit 2 - Write Protection Control Register Enable"]
    #[inline(always)]
