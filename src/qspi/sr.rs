...
#[doc = "Field `RDRF` reader - Receive Data Register Full (cleared by reading QSPI_RDR)"]
pub type RdrfR = crate::BitReader;
#[doc = "Field `TDRE` reader - Transmit Data Register Empty (cleared by writing QSPI_TDR)"]
pub type TdreR = crate::BitReader;
#[doc = "Field `TXEMPTY` reader - Transmission Registers Empty (cleared by writing QSPI_TDR)"]
...
impl R {
    #[doc = "Bit 0 - Receive Data Register Full (cleared by reading QSPI_RDR)"]
    #[inline(always)]
    pub fn rdrf(&self) -> RdrfR {
        RdrfR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Transmit Data Register Empty (cleared by writing QSPI_TDR)"]
    #[inline(always)]
    pub fn tdre(&self) -> TdreR {
        TdreR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Transmission Registers Empty (cleared by writing QSPI_TDR)"]
    #[inline(always)]
