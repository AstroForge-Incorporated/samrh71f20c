...
#[doc = "Field `SMRM` reader - Serial Memory Register Mode"]
pub type SmrmR = crate::BitReader;
#[doc = "Field `SMRM` writer - Serial Memory Register Mode"]
pub type SmrmW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 3 - Serial Memory Register Mode"]
    #[inline(always)]
    pub fn smrm(&self) -> SmrmR {
        SmrmR::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 3 - Serial Memory Register Mode"]
    #[inline(always)]
    pub fn smrm(&mut self) -> SmrmW<MrSpec> {
        SmrmW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Chip Select Mode"]
    #[inline(always)]
