...
#[doc = "Field `LOCKMR` writer - Lock Mode Register Write Access"]
pub type LockmrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Password\n\nValue on reset: 0"]
...
impl W {
    ...
    #[doc = "Bit 4 - Lock Mode Register Write Access"]
    #[inline(always)]
    pub fn lockmr(&mut self) -> LockmrW<CrSpec> {
        LockmrW::new(self, 4)
    }
