#[doc = "Register `SCFG4R` reader"]
pub type R = crate::R<Scfg4rSpec>;
#[doc = "Register `SCFG4R` writer"]
pub type W = crate::W<Scfg4rSpec>;
...
impl W {
    #[doc = "Bits 0:1 - Glitch Filter Selector (GFSEL field is read-only in NMIC_SCFG1 to 8)"]
    #[inline(always)]
    pub fn gfsel(&mut self) -> GfselW<Scfg4rSpec> {
        GfselW::new(self, 0)
    }
    #[doc = "Bit 4 - Glitch Filter Enable (GFEN bit is read-only in NMIC_SCFG1 to 8)"]
    #[inline(always)]
    pub fn gfen(&mut self) -> GfenW<Scfg4rSpec> {
        GfenW::new(self, 4)
    }
    #[doc = "Bit 8 - Polarity (POL bit is read-only in NMIC_SCFG1 to 8)"]
    #[inline(always)]
    pub fn pol(&mut self) -> PolW<Scfg4rSpec> {
        PolW::new(self, 8)
    }
    #[doc = "Bit 9 - Level Detection (LVL bit is read-only in NMIC_SCFG1 to 8)"]
    #[inline(always)]
    pub fn lvl(&mut self) -> LvlW<Scfg4rSpec> {
        LvlW::new(self, 9)
    }
    #[doc = "Bit 16 - Source Enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<Scfg4rSpec> {
        EnW::new(self, 16)
    }
    #[doc = "Bit 31 - Interrupt Line Freeze"]
    #[inline(always)]
    pub fn frz(&mut self) -> FrzW<Scfg4rSpec> {
        FrzW::new(self, 31)
    }
}
#[doc = "Source Configuration Register 4\n\nYou can [`read`](crate::Reg::read) this register and get [`scfg4r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scfg4r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scfg4rSpec;
impl crate::RegisterSpec for Scfg4rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scfg4r::R`](R) reader structure"]
impl crate::Readable for Scfg4rSpec {}
#[doc = "`write(|w| ..)` method takes [`scfg4r::W`](W) writer structure"]
impl crate::Writable for Scfg4rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SCFG4R to value 0"]
impl crate::Resettable for Scfg4rSpec {}
