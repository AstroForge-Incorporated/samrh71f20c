#[doc = "Register `SCFG8R` reader"]
pub type R = crate::R<Scfg8rSpec>;
#[doc = "Register `SCFG8R` writer"]
pub type W = crate::W<Scfg8rSpec>;
...
impl W {
    #[doc = "Bits 0:1 - Glitch Filter Selector (GFSEL field is read-only in NMIC_SCFG1 to 8)"]
    #[inline(always)]
    pub fn gfsel(&mut self) -> GfselW<Scfg8rSpec> {
        GfselW::new(self, 0)
    }
    #[doc = "Bit 4 - Glitch Filter Enable (GFEN bit is read-only in NMIC_SCFG1 to 8)"]
    #[inline(always)]
    pub fn gfen(&mut self) -> GfenW<Scfg8rSpec> {
        GfenW::new(self, 4)
    }
    #[doc = "Bit 8 - Polarity (POL bit is read-only in NMIC_SCFG1 to 8)"]
    #[inline(always)]
    pub fn pol(&mut self) -> PolW<Scfg8rSpec> {
        PolW::new(self, 8)
    }
    #[doc = "Bit 9 - Level Detection (LVL bit is read-only in NMIC_SCFG1 to 8)"]
    #[inline(always)]
    pub fn lvl(&mut self) -> LvlW<Scfg8rSpec> {
        LvlW::new(self, 9)
    }
    #[doc = "Bit 16 - Source Enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<Scfg8rSpec> {
        EnW::new(self, 16)
    }
    #[doc = "Bit 31 - Interrupt Line Freeze"]
    #[inline(always)]
    pub fn frz(&mut self) -> FrzW<Scfg8rSpec> {
        FrzW::new(self, 31)
    }
}
#[doc = "Source Configuration Register 8\n\nYou can [`read`](crate::Reg::read) this register and get [`scfg8r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scfg8r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scfg8rSpec;
impl crate::RegisterSpec for Scfg8rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scfg8r::R`](R) reader structure"]
impl crate::Readable for Scfg8rSpec {}
#[doc = "`write(|w| ..)` method takes [`scfg8r::W`](W) writer structure"]
impl crate::Writable for Scfg8rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SCFG8R to value 0"]
impl crate::Resettable for Scfg8rSpec {}
