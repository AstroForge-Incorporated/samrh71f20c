...
pub enum Gclkcssselect {
    ...
    PllaClk = 2,
    #[doc = "3: PLLBCK is selected"]
    PllbClk = 3,
    #[doc = "4: MCK is selected"]
    MckClk = 4,
    #[doc = "5: RC2 is selected"]
    MckRc2 = 5,
}
...
impl GclkcssR {
    ...
    pub const fn variant(&self) -> Option<Gclkcssselect> {
        match self.bits {
            ...
            3 => Some(Gclkcssselect::PllbClk),
            4 => Some(Gclkcssselect::MckClk),
            5 => Some(Gclkcssselect::MckRc2),
            _ => None,
        }
    }
    ...
    #[doc = "PLLBCK is selected"]
    #[inline(always)]
    pub fn is_pllb_clk(&self) -> bool {
        *self == Gclkcssselect::PllbClk
    }
    #[doc = "MCK is selected"]
    #[inline(always)]
    ...
    #[doc = "RC2 is selected"]
    #[inline(always)]
    pub fn is_mck_rc2(&self) -> bool {
        *self == Gclkcssselect::MckRc2
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn pllb_clk(self) -> &'a mut crate::W<REG> {
        self.variant(Gclkcssselect::PllbClk)
    }
    #[doc = "MCK is selected"]
    #[inline(always)]
    ...
    #[doc = "RC2 is selected"]
    #[inline(always)]
    pub fn mck_rc2(self) -> &'a mut crate::W<REG> {
        self.variant(Gclkcssselect::MckRc2)
    }
}
