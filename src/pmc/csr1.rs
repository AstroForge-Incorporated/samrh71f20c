...
#[doc = "Field `PID54` reader - Peripheral Clock 54 Status"]
pub type Pid54R = crate::BitReader;
#[doc = "Field `PID55` reader - Peripheral Clock 55 Status"]
pub type Pid55R = crate::BitReader;
...
#[doc = "Field `PID61` reader - Peripheral Clock 61 Status"]
pub type Pid61R = crate::BitReader;
#[doc = "Field `PID62` reader - Peripheral Clock 62 Status"]
pub type Pid62R = crate::BitReader;
#[doc = "Field `PID63` reader - Peripheral Clock 63 Status"]
pub type Pid63R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 22 - Peripheral Clock 54 Status"]
    #[inline(always)]
    pub fn pid54(&self) -> Pid54R {
        Pid54R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Peripheral Clock 55 Status"]
    #[inline(always)]
    pub fn pid55(&self) -> Pid55R {
        Pid55R::new(((self.bits >> 23) & 1) != 0)
    }
    ...
    #[doc = "Bit 29 - Peripheral Clock 61 Status"]
    #[inline(always)]
    pub fn pid61(&self) -> Pid61R {
        Pid61R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - Peripheral Clock 62 Status"]
    #[inline(always)]
    pub fn pid62(&self) -> Pid62R {
        Pid62R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Peripheral Clock 63 Status"]
    #[inline(always)]
    pub fn pid63(&self) -> Pid63R {
        Pid63R::new(((self.bits >> 31) & 1) != 0)
    }
}
