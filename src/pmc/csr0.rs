...
#[doc = "Field `PID0` reader - Peripheral Clock 0 Status"]
pub type Pid0R = crate::BitReader;
#[doc = "Field `PID1` reader - Peripheral Clock 1 Status"]
pub type Pid1R = crate::BitReader;
...
impl R {
    #[doc = "Bit 0 - Peripheral Clock 0 Status"]
    #[inline(always)]
    pub fn pid0(&self) -> Pid0R {
        Pid0R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Peripheral Clock 1 Status"]
    #[inline(always)]
...
#[doc = "Peripheral Clock Status Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`csr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Csr0Spec;
