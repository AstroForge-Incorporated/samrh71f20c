...
pub type R = crate::R<Ocr2Spec>;
#[doc = "Register `OCR2` writer"]
pub type W = crate::W<Ocr2Spec>;
...
impl R {
    ...
    #[doc = "Bit 31 - Selection of Main RC Oscillator Calibration Bits for 10 MHz"]
    #[inline(always)]
    pub fn sel10(&self) -> Sel10R {
        Sel10R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:6 - Main RC Oscillator Calibration Bits for 4 MHz"]
    #[inline(always)]
    pub fn cal4(&mut self) -> Cal4W<Ocr2Spec> {
        Cal4W::new(self, 0)
    }
    #[doc = "Bit 7 - Selection of Main RC Oscillator Calibration Bits for 4 MHz"]
    #[inline(always)]
    pub fn sel4(&mut self) -> Sel4W<Ocr2Spec> {
        Sel4W::new(self, 7)
    }
    #[doc = "Bits 8:14 - Main RC Oscillator Calibration Bits for 8 MHz"]
    #[inline(always)]
    pub fn cal8(&mut self) -> Cal8W<Ocr2Spec> {
        Cal8W::new(self, 8)
    }
    #[doc = "Bit 15 - Selection of Main RC Oscillator Calibration Bits for 8 MHz"]
    #[inline(always)]
    pub fn sel8(&mut self) -> Sel8W<Ocr2Spec> {
        Sel8W::new(self, 15)
    }
    #[doc = "Bits 16:22 - Main RC Oscillator Calibration Bits for 12 MHz"]
    #[inline(always)]
    pub fn cal12(&mut self) -> Cal12W<Ocr2Spec> {
        Cal12W::new(self, 16)
    }
    #[doc = "Bit 23 - Selection of Main RC Oscillator Calibration Bits for 12 MHz"]
    #[inline(always)]
    pub fn sel12(&mut self) -> Sel12W<Ocr2Spec> {
        Sel12W::new(self, 23)
    }
    #[doc = "Bits 24:30 - Main RC Oscillator Calibration Bits for 10 MHz"]
    #[inline(always)]
    pub fn cal10(&mut self) -> Cal10W<Ocr2Spec> {
        Cal10W::new(self, 24)
    }
    #[doc = "Bit 31 - Selection of Main RC Oscillator Calibration Bits for 10 MHz"]
    #[inline(always)]
    pub fn sel10(&mut self) -> Sel10W<Ocr2Spec> {
        Sel10W::new(self, 31)
    }
}
#[doc = "Oscillator Calibration Register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`ocr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ocr2Spec;
impl crate::RegisterSpec for Ocr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ocr2::R`](R) reader structure"]
impl crate::Readable for Ocr2Spec {}
#[doc = "`write(|w| ..)` method takes [`ocr2::W`](W) writer structure"]
impl crate::Writable for Ocr2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCR2 to value 0"]
impl crate::Resettable for Ocr2Spec {}
