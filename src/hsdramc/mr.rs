...
pub enum Modeselect {
    ...
    LoadModereg = 3,
    #[doc = "4: The SDRAMC issues an 'Autorefresh' Command when the SDRAM device is accessed regardless of the cycle. Previously, an 'All Banks Precharge' command must be issued. To activate this mode, the command must be followed by a write to the SDRAM."]
    AutoRefresh = 4,
...
impl ModeR {
    ...
    #[doc = "The SDRAMC issues an 'Autorefresh' Command when the SDRAM device is accessed regardless of the cycle. Previously, an 'All Banks Precharge' command must be issued. To activate this mode, the command must be followed by a write to the SDRAM."]
    #[inline(always)]
