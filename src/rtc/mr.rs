...
#[doc = "Field `EN0` reader - PIO Line Enable"]
pub type En0R = crate::BitReader;
#[doc = "Field `EN0` writer - PIO Line Enable"]
...
#[doc = "Field `EN1` reader - PIO Line Enable"]
pub type En1R = crate::BitReader;
#[doc = "Field `EN1` writer - PIO Line Enable"]
...
impl R {
    ...
    #[doc = "Bit 19 - PIO Line Enable"]
    #[inline(always)]
    pub fn en0(&self) -> En0R {
        En0R::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    #[doc = "Bit 23 - PIO Line Enable"]
    #[inline(always)]
    pub fn en1(&self) -> En1R {
        En1R::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 19 - PIO Line Enable"]
    #[inline(always)]
    pub fn en0(&mut self) -> En0W<MrSpec> {
        En0W::new(self, 19)
    }
    #[doc = "Bits 20:22 - RTCOUT1 Output Source Selection"]
    #[inline(always)]
    ...
    #[doc = "Bit 23 - PIO Line Enable"]
    #[inline(always)]
    pub fn en1(&mut self) -> En1W<MrSpec> {
        En1W::new(self, 23)
    }
    #[doc = "Bits 24:26 - High Duration of the Output Pulse"]
    #[inline(always)]
