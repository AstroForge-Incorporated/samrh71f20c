...
#[doc = "Field `SRTSM` reader - Store Receive Timestamp to Memory"]
pub type SrtsmR = crate::BitReader;
#[doc = "Field `SRTSM` writer - Store Receive Timestamp to Memory"]
...
impl R {
    ...
    #[doc = "Bit 15 - Store Receive Timestamp to Memory"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 19 - Enable LPI Transmission"]
    #[inline(always)]
    pub fn txlpien(&mut self) -> TxlpienW<NcrSpec> {
