...
#[doc = "Field `WPEN` reader - Write Protection Configuration Enable"]
pub type WpenR = crate::BitReader;
#[doc = "Field `WPEN` writer - Write Protection Configuration Enable"]
pub type WpenW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `WPITEN` reader - Write Protection Interruption Enable"]
pub type WpitenR = crate::BitReader;
#[doc = "Field `WPITEN` writer - Write Protection Interruption Enable"]
...
pub enum Wpkeyselect {
    #[doc = "5457985: Writing any other value in this field aborts the write operation of the WPEN,WPITEN,WPCREN bits. Always reads as 0."]
    Passwd = 5457985,
}
...
impl WpkeyR {
    ...
    pub const fn variant(&self) -> Option<Wpkeyselect> {
        match self.bits {
            5457985 => Some(Wpkeyselect::Passwd),
            _ => None,
        }
    }
    #[doc = "Writing any other value in this field aborts the write operation of the WPEN,WPITEN,WPCREN bits. Always reads as 0."]
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Write Protection Configuration Enable"]
    #[inline(always)]
    pub fn wpen(&self) -> WpenR {
        WpenR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Write Protection Interruption Enable"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 1 - Write Protection Interruption Enable"]
    #[inline(always)]
    pub fn wpiten(&mut self) -> WpitenW<WpmrSpec> {
        WpitenW::new(self, 1)
    }
    #[doc = "Bit 2 - Write Protection Control Enable"]
    #[inline(always)]
    pub fn wpcren(&mut self) -> WpcrenW<WpmrSpec> {
        WpcrenW::new(self, 2)
    }
    #[doc = "Bits 8:31 - Write Protection Key"]
    #[inline(always)]
