...
impl From<Tc0xc0sselect> for u8 {
    #[inline(always)]
    fn from(variant: Tc0xc0sselect) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tc0xc0sselect {
    type Ux = u8;
}
impl crate::IsEnum for Tc0xc0sselect {}
#[doc = "Field `TC0XC0S` reader - External Clock Signal 0 Selection"]
pub type Tc0xc0sR = crate::FieldReader<Tc0xc0sselect>;
impl Tc0xc0sR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tc0xc0sselect> {
        match self.bits {
            0 => Some(Tc0xc0sselect::Tclk0),
            2 => Some(Tc0xc0sselect::Tioa1),
            3 => Some(Tc0xc0sselect::Tioa2),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn tclk0(self) -> &'a mut crate::W<REG> {
        self.variant(Tc0xc0sselect::Tclk0)
    }
    #[doc = "Signal connected to XC0: TIOA1"]
    #[inline(always)]
    pub fn tioa1(self) -> &'a mut crate::W<REG> {
        self.variant(Tc0xc0sselect::Tioa1)
    }
    #[doc = "Signal connected to XC0: TIOA2"]
    #[inline(always)]
    pub fn tioa2(self) -> &'a mut crate::W<REG> {
        self.variant(Tc0xc0sselect::Tioa2)
    }
}
#[doc = "External Clock Signal 1 Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tc1xc1sselect {
...
impl From<Tc1xc1sselect> for u8 {
    #[inline(always)]
    fn from(variant: Tc1xc1sselect) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tc1xc1sselect {
    type Ux = u8;
}
impl crate::IsEnum for Tc1xc1sselect {}
#[doc = "Field `TC1XC1S` reader - External Clock Signal 1 Selection"]
pub type Tc1xc1sR = crate::FieldReader<Tc1xc1sselect>;
impl Tc1xc1sR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tc1xc1sselect> {
        match self.bits {
            0 => Some(Tc1xc1sselect::Tclk1),
            2 => Some(Tc1xc1sselect::Tioa0),
            3 => Some(Tc1xc1sselect::Tioa2),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn tclk1(self) -> &'a mut crate::W<REG> {
        self.variant(Tc1xc1sselect::Tclk1)
    }
    #[doc = "Signal connected to XC1: TIOA0"]
    #[inline(always)]
    pub fn tioa0(self) -> &'a mut crate::W<REG> {
        self.variant(Tc1xc1sselect::Tioa0)
    }
    #[doc = "Signal connected to XC1: TIOA2"]
    #[inline(always)]
    pub fn tioa2(self) -> &'a mut crate::W<REG> {
        self.variant(Tc1xc1sselect::Tioa2)
    }
}
#[doc = "External Clock Signal 2 Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tc2xc2sselect {
...
impl From<Tc2xc2sselect> for u8 {
    #[inline(always)]
    fn from(variant: Tc2xc2sselect) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tc2xc2sselect {
    type Ux = u8;
}
impl crate::IsEnum for Tc2xc2sselect {}
#[doc = "Field `TC2XC2S` reader - External Clock Signal 2 Selection"]
pub type Tc2xc2sR = crate::FieldReader<Tc2xc2sselect>;
impl Tc2xc2sR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tc2xc2sselect> {
        match self.bits {
            0 => Some(Tc2xc2sselect::Tclk2),
            2 => Some(Tc2xc2sselect::Tioa0),
            3 => Some(Tc2xc2sselect::Tioa1),
            _ => None,
        }
    }
    ...
    pub fn is_tclk2(&self) -> bool {
        *self == Tc2xc2sselect::Tclk2
    }
    #[doc = "Signal connected to XC2: TIOA0"]
    #[inline(always)]
    pub fn is_tioa0(&self) -> bool {
        *self == Tc2xc2sselect::Tioa0
    }
    #[doc = "Signal connected to XC2: TIOA1"]
    #[inline(always)]
    pub fn is_tioa1(&self) -> bool {
        *self == Tc2xc2sselect::Tioa1
    }
}
#[doc = "Field `TC2XC2S` writer - External Clock Signal 2 Selection"]
pub type Tc2xc2sW<'a, REG> = crate::FieldWriter<'a, REG, 2, Tc2xc2sselect>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn tclk2(self) -> &'a mut crate::W<REG> {
        self.variant(Tc2xc2sselect::Tclk2)
    }
    #[doc = "Signal connected to XC2: TIOA0"]
    #[inline(always)]
    pub fn tioa0(self) -> &'a mut crate::W<REG> {
        self.variant(Tc2xc2sselect::Tioa0)
    }
    #[doc = "Signal connected to XC2: TIOA1"]
    #[inline(always)]
    pub fn tioa1(self) -> &'a mut crate::W<REG> {
        self.variant(Tc2xc2sselect::Tioa1)
    }
}
