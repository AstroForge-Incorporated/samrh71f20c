...
pub enum Wpkeyselect {
    #[doc = "4801357: Writing any other value in this field aborts the write operation of the WPEN, WPITEN and WPCREN bits. Always reads as 0"]
    Passwd = 4801357,
}
...
impl WpkeyR {
    ...
    pub const fn variant(&self) -> Option<Wpkeyselect> {
        match self.bits {
            4801357 => Some(Wpkeyselect::Passwd),
            _ => None,
        }
    }
    #[doc = "Writing any other value in this field aborts the write operation of the WPEN, WPITEN and WPCREN bits. Always reads as 0"]
    #[inline(always)]
