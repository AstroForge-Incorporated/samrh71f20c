...
#[doc = "Field `ADDRESS` reader - address of the error detected (refers to instruction memory)"]
pub type AddressR = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - address of the error detected (refers to instruction memory)"]
    #[inline(always)]
