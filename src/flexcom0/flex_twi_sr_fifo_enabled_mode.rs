#[doc = "Register `FLEX_TWI_SR_FIFO_ENABLED_MODE` reader"]
pub type R = crate::R<FlexTwiSrFifoEnabledModeSpec>;
...
impl R {
    ...
    #[doc = "Bit 23 - Transmit FIFO Lock"]
    #[inline(always)]
    pub fn txflock(&self) -> TxflockR {
        TxflockR::new(((self.bits >> 23) & 1) != 0)
    }
...
#[doc = "TWI Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`flex_twi_sr_fifo_enabled_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlexTwiSrFifoEnabledModeSpec;
impl crate::RegisterSpec for FlexTwiSrFifoEnabledModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_twi_sr_fifo_enabled_mode::R`](R) reader structure"]
impl crate::Readable for FlexTwiSrFifoEnabledModeSpec {}
#[doc = "`reset()` method sets FLEX_TWI_SR_FIFO_ENABLED_MODE to value 0"]
impl crate::Resettable for FlexTwiSrFifoEnabledModeSpec {}
