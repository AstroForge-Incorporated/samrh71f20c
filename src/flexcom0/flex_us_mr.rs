#[doc = "Register `FLEX_US_MR` reader"]
pub type R = crate::R<FlexUsMrSpec>;
#[doc = "Register `FLEX_US_MR` writer"]
pub type W = crate::W<FlexUsMrSpec>;
...
pub enum Usclksselect {
    ...
    Div = 1,
    #[doc = "2: PMC generic clock is selected. If the SCK pin is driven (CLKO = 1), the CD field must be greater than 1."]
    Gclk = 2,
    #[doc = "3: External pin SCK is selected"]
    Sck = 3,
}
...
impl UsclksR {
    ...
    #[doc = "PMC generic clock is selected. If the SCK pin is driven (CLKO = 1), the CD field must be greater than 1."]
    #[inline(always)]
    pub fn is_gclk(&self) -> bool {
        *self == Usclksselect::Gclk
    }
    #[doc = "External pin SCK is selected"]
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn gclk(self) -> &'a mut crate::W<REG> {
        self.variant(Usclksselect::Gclk)
    }
    #[doc = "External pin SCK is selected"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:3 - USART Mode of Operation"]
    #[inline(always)]
    pub fn usart_mode(&mut self) -> UsartModeW<FlexUsMrSpec> {
        UsartModeW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Clock Selection"]
    #[inline(always)]
    pub fn usclks(&mut self) -> UsclksW<FlexUsMrSpec> {
        UsclksW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Character Length"]
    #[inline(always)]
    pub fn chrl(&mut self) -> ChrlW<FlexUsMrSpec> {
        ChrlW::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous Mode Select"]
    #[inline(always)]
    pub fn sync(&mut self) -> SyncW<FlexUsMrSpec> {
        SyncW::new(self, 8)
    }
    #[doc = "Bits 9:11 - Parity Type"]
    #[inline(always)]
    pub fn par(&mut self) -> ParW<FlexUsMrSpec> {
        ParW::new(self, 9)
    }
    #[doc = "Bits 12:13 - Number of Stop Bits"]
    #[inline(always)]
    pub fn nbstop(&mut self) -> NbstopW<FlexUsMrSpec> {
        NbstopW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Channel Mode"]
    #[inline(always)]
    pub fn chmode(&mut self) -> ChmodeW<FlexUsMrSpec> {
        ChmodeW::new(self, 14)
    }
    #[doc = "Bit 16 - Bit Order"]
    #[inline(always)]
    pub fn msbf(&mut self) -> MsbfW<FlexUsMrSpec> {
        MsbfW::new(self, 16)
    }
    #[doc = "Bit 17 - 9-bit Character Length"]
    #[inline(always)]
    pub fn mode9(&mut self) -> Mode9W<FlexUsMrSpec> {
        Mode9W::new(self, 17)
    }
    #[doc = "Bit 18 - Clock Output Select"]
    #[inline(always)]
    pub fn clko(&mut self) -> ClkoW<FlexUsMrSpec> {
        ClkoW::new(self, 18)
    }
    #[doc = "Bit 19 - Oversampling Mode"]
    #[inline(always)]
    pub fn over(&mut self) -> OverW<FlexUsMrSpec> {
        OverW::new(self, 19)
    }
    #[doc = "Bit 20 - Inhibit Non Acknowledge"]
    #[inline(always)]
    pub fn inack(&mut self) -> InackW<FlexUsMrSpec> {
        InackW::new(self, 20)
    }
    #[doc = "Bit 21 - Disable Successive NACK"]
    #[inline(always)]
    pub fn dsnack(&mut self) -> DsnackW<FlexUsMrSpec> {
        DsnackW::new(self, 21)
    }
    #[doc = "Bit 22 - Variable Synchronization of Command/Data Sync Start Frame Delimiter"]
    #[inline(always)]
    pub fn var_sync(&mut self) -> VarSyncW<FlexUsMrSpec> {
        VarSyncW::new(self, 22)
    }
    #[doc = "Bit 23 - Inverted Data"]
    #[inline(always)]
    pub fn invdata(&mut self) -> InvdataW<FlexUsMrSpec> {
        InvdataW::new(self, 23)
    }
    #[doc = "Bits 24:26 - Maximum Number of Automatic Iteration"]
    #[inline(always)]
    pub fn max_iteration(&mut self) -> MaxIterationW<FlexUsMrSpec> {
        MaxIterationW::new(self, 24)
    }
    #[doc = "Bit 28 - Receive Line Filter"]
    #[inline(always)]
    pub fn filter(&mut self) -> FilterW<FlexUsMrSpec> {
        FilterW::new(self, 28)
    }
    #[doc = "Bit 29 - Manchester Encoder/Decoder Enable"]
    #[inline(always)]
    pub fn man(&mut self) -> ManW<FlexUsMrSpec> {
        ManW::new(self, 29)
    }
    #[doc = "Bit 30 - Manchester Synchronization Mode"]
    #[inline(always)]
    pub fn modsync(&mut self) -> ModsyncW<FlexUsMrSpec> {
        ModsyncW::new(self, 30)
    }
    #[doc = "Bit 31 - Start Frame Delimiter Selector"]
    #[inline(always)]
    pub fn onebit(&mut self) -> OnebitW<FlexUsMrSpec> {
        OnebitW::new(self, 31)
    }
}
#[doc = "USART Mode Register\n\nYou can [`read`](crate::Reg::read) this register and get [`flex_us_mr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flex_us_mr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlexUsMrSpec;
impl crate::RegisterSpec for FlexUsMrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_us_mr::R`](R) reader structure"]
impl crate::Readable for FlexUsMrSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_us_mr::W`](W) writer structure"]
impl crate::Writable for FlexUsMrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FLEX_US_MR to value 0"]
impl crate::Resettable for FlexUsMrSpec {}
