#[doc = "Register `FLEX_US_CSR_LIN_MODE_MODE` reader"]
pub type R = crate::R<FlexUsCsrLinModeModeSpec>;
...
#[doc = "USART Channel Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`flex_us_csr_lin_mode_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlexUsCsrLinModeModeSpec;
impl crate::RegisterSpec for FlexUsCsrLinModeModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_us_csr_lin_mode_mode::R`](R) reader structure"]
impl crate::Readable for FlexUsCsrLinModeModeSpec {}
#[doc = "`reset()` method sets FLEX_US_CSR_LIN_MODE_MODE to value 0"]
impl crate::Resettable for FlexUsCsrLinModeModeSpec {}
