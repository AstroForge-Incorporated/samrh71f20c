#[doc = "Register `FLEX_SPI_WPMR` reader"]
pub type R = crate::R<FlexSpiWpmrSpec>;
#[doc = "Register `FLEX_SPI_WPMR` writer"]
pub type W = crate::W<FlexSpiWpmrSpec>;
...
pub enum Wpkeyselect {
    #[doc = "5460041: Writing any other value in this field aborts the write operation of bits WPEN, WPITEN and WPCREN. Always reads as 0"]
    Passwd = 5460041,
}
...
impl WpkeyR {
    ...
    pub const fn variant(&self) -> Option<Wpkeyselect> {
        match self.bits {
            5460041 => Some(Wpkeyselect::Passwd),
            _ => None,
        }
    }
...
impl W {
    #[doc = "Bit 0 - Write Protection Enable"]
    #[inline(always)]
    pub fn wpen(&mut self) -> WpenW<FlexSpiWpmrSpec> {
        WpenW::new(self, 0)
    }
    #[doc = "Bit 1 - Write Protection Interrupt Enable"]
    #[inline(always)]
    pub fn wpiten(&mut self) -> WpitenW<FlexSpiWpmrSpec> {
        WpitenW::new(self, 1)
    }
    #[doc = "Bit 2 - Write Protection Control Enable"]
    #[inline(always)]
    pub fn wpcren(&mut self) -> WpcrenW<FlexSpiWpmrSpec> {
        WpcrenW::new(self, 2)
    }
    #[doc = "Bits 8:31 - Write Protection Key"]
    #[inline(always)]
    pub fn wpkey(&mut self) -> WpkeyW<FlexSpiWpmrSpec> {
        WpkeyW::new(self, 8)
    }
}
#[doc = "SPI Write Protection Mode Register\n\nYou can [`read`](crate::Reg::read) this register and get [`flex_spi_wpmr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flex_spi_wpmr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlexSpiWpmrSpec;
impl crate::RegisterSpec for FlexSpiWpmrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_spi_wpmr::R`](R) reader structure"]
impl crate::Readable for FlexSpiWpmrSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_spi_wpmr::W`](W) writer structure"]
impl crate::Writable for FlexSpiWpmrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FLEX_SPI_WPMR to value 0"]
impl crate::Resettable for FlexSpiWpmrSpec {}
