#[doc = "Register `FLEX_TWI_FIMR` reader"]
pub type R = crate::R<FlexTwiFimrSpec>;
...
#[doc = "TWI FIFO Interrupt Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`flex_twi_fimr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlexTwiFimrSpec;
impl crate::RegisterSpec for FlexTwiFimrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_twi_fimr::R`](R) reader structure"]
impl crate::Readable for FlexTwiFimrSpec {}
#[doc = "`reset()` method sets FLEX_TWI_FIMR to value 0"]
impl crate::Resettable for FlexTwiFimrSpec {}
