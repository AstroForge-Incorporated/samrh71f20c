#[doc = "Register `FLEX_US_MAN` reader"]
pub type R = crate::R<FlexUsManSpec>;
#[doc = "Register `FLEX_US_MAN` writer"]
pub type W = crate::W<FlexUsManSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Transmitter Preamble Length"]
    #[inline(always)]
    pub fn tx_pl(&mut self) -> TxPlW<FlexUsManSpec> {
        TxPlW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Transmitter Preamble Pattern"]
    #[inline(always)]
    pub fn tx_pp(&mut self) -> TxPpW<FlexUsManSpec> {
        TxPpW::new(self, 8)
    }
    #[doc = "Bit 12 - Transmitter Manchester Polarity"]
    #[inline(always)]
    pub fn tx_mpol(&mut self) -> TxMpolW<FlexUsManSpec> {
        TxMpolW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Receiver Preamble Length"]
    #[inline(always)]
    pub fn rx_pl(&mut self) -> RxPlW<FlexUsManSpec> {
        RxPlW::new(self, 16)
    }
    #[doc = "Bits 24:25 - Receiver Preamble Pattern detected"]
    #[inline(always)]
    pub fn rx_pp(&mut self) -> RxPpW<FlexUsManSpec> {
        RxPpW::new(self, 24)
    }
    #[doc = "Bit 28 - Receiver Manchester Polarity"]
    #[inline(always)]
    pub fn rx_mpol(&mut self) -> RxMpolW<FlexUsManSpec> {
        RxMpolW::new(self, 28)
    }
    #[doc = "Bit 29 - Must Be Set to 1"]
    #[inline(always)]
    pub fn one(&mut self) -> OneW<FlexUsManSpec> {
        OneW::new(self, 29)
    }
    #[doc = "Bit 30 - Drift Compensation"]
    #[inline(always)]
    pub fn drift(&mut self) -> DriftW<FlexUsManSpec> {
        DriftW::new(self, 30)
    }
    #[doc = "Bit 31 - Receiver Idle Value"]
    #[inline(always)]
    pub fn rxidlev(&mut self) -> RxidlevW<FlexUsManSpec> {
        RxidlevW::new(self, 31)
    }
}
#[doc = "USART Manchester Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`flex_us_man::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flex_us_man::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlexUsManSpec;
impl crate::RegisterSpec for FlexUsManSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_us_man::R`](R) reader structure"]
impl crate::Readable for FlexUsManSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_us_man::W`](W) writer structure"]
impl crate::Writable for FlexUsManSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FLEX_US_MAN to value 0"]
impl crate::Resettable for FlexUsManSpec {}
