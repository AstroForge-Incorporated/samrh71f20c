...
#[doc = "Field `DI24` writer - XDMAC Channel 24 Disable Bit"]
pub type Di24W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DI25` writer - XDMAC Channel 25 Disable Bit"]
pub type Di25W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DI26` writer - XDMAC Channel 26 Disable Bit"]
pub type Di26W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DI27` writer - XDMAC Channel 27 Disable Bit"]
pub type Di27W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DI28` writer - XDMAC Channel 28 Disable Bit"]
pub type Di28W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DI29` writer - XDMAC Channel 29 Disable Bit"]
pub type Di29W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DI30` writer - XDMAC Channel 30 Disable Bit"]
pub type Di30W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DI31` writer - XDMAC Channel 31 Disable Bit"]
...
impl W {
    ...
    #[doc = "Bit 24 - XDMAC Channel 24 Disable Bit"]
    #[inline(always)]
    pub fn di24(&mut self) -> Di24W<GdSpec> {
        Di24W::new(self, 24)
    }
    #[doc = "Bit 25 - XDMAC Channel 25 Disable Bit"]
    #[inline(always)]
    pub fn di25(&mut self) -> Di25W<GdSpec> {
        Di25W::new(self, 25)
    }
    #[doc = "Bit 26 - XDMAC Channel 26 Disable Bit"]
    #[inline(always)]
    pub fn di26(&mut self) -> Di26W<GdSpec> {
        Di26W::new(self, 26)
    }
    #[doc = "Bit 27 - XDMAC Channel 27 Disable Bit"]
    #[inline(always)]
    pub fn di27(&mut self) -> Di27W<GdSpec> {
        Di27W::new(self, 27)
    }
    #[doc = "Bit 28 - XDMAC Channel 28 Disable Bit"]
    #[inline(always)]
    pub fn di28(&mut self) -> Di28W<GdSpec> {
        Di28W::new(self, 28)
    }
    #[doc = "Bit 29 - XDMAC Channel 29 Disable Bit"]
    #[inline(always)]
    pub fn di29(&mut self) -> Di29W<GdSpec> {
        Di29W::new(self, 29)
    }
    #[doc = "Bit 30 - XDMAC Channel 30 Disable Bit"]
    #[inline(always)]
    pub fn di30(&mut self) -> Di30W<GdSpec> {
        Di30W::new(self, 30)
    }
    #[doc = "Bit 31 - XDMAC Channel 31 Disable Bit"]
    #[inline(always)]
    pub fn di31(&mut self) -> Di31W<GdSpec> {
        Di31W::new(self, 31)
    }
}
