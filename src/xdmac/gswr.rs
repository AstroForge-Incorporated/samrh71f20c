...
#[doc = "Field `SWREQ24` writer - XDMAC Channel 24 Software Request Bit"]
pub type Swreq24W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWREQ25` writer - XDMAC Channel 25 Software Request Bit"]
pub type Swreq25W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWREQ26` writer - XDMAC Channel 26 Software Request Bit"]
pub type Swreq26W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWREQ27` writer - XDMAC Channel 27 Software Request Bit"]
pub type Swreq27W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWREQ28` writer - XDMAC Channel 28 Software Request Bit"]
pub type Swreq28W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWREQ29` writer - XDMAC Channel 29 Software Request Bit"]
pub type Swreq29W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWREQ30` writer - XDMAC Channel 30 Software Request Bit"]
pub type Swreq30W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWREQ31` writer - XDMAC Channel 31 Software Request Bit"]
pub type Swreq31W<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[doc = "Bit 24 - XDMAC Channel 24 Software Request Bit"]
    #[inline(always)]
    pub fn swreq24(&mut self) -> Swreq24W<GswrSpec> {
        Swreq24W::new(self, 24)
    }
    #[doc = "Bit 25 - XDMAC Channel 25 Software Request Bit"]
    #[inline(always)]
    pub fn swreq25(&mut self) -> Swreq25W<GswrSpec> {
        Swreq25W::new(self, 25)
    }
    #[doc = "Bit 26 - XDMAC Channel 26 Software Request Bit"]
    #[inline(always)]
    pub fn swreq26(&mut self) -> Swreq26W<GswrSpec> {
        Swreq26W::new(self, 26)
    }
    #[doc = "Bit 27 - XDMAC Channel 27 Software Request Bit"]
    #[inline(always)]
    pub fn swreq27(&mut self) -> Swreq27W<GswrSpec> {
        Swreq27W::new(self, 27)
    }
    #[doc = "Bit 28 - XDMAC Channel 28 Software Request Bit"]
    #[inline(always)]
    pub fn swreq28(&mut self) -> Swreq28W<GswrSpec> {
        Swreq28W::new(self, 28)
    }
    #[doc = "Bit 29 - XDMAC Channel 29 Software Request Bit"]
    #[inline(always)]
    pub fn swreq29(&mut self) -> Swreq29W<GswrSpec> {
        Swreq29W::new(self, 29)
    }
    #[doc = "Bit 30 - XDMAC Channel 30 Software Request Bit"]
    #[inline(always)]
    pub fn swreq30(&mut self) -> Swreq30W<GswrSpec> {
        Swreq30W::new(self, 30)
    }
    #[doc = "Bit 31 - XDMAC Channel 31 Software Request Bit"]
    #[inline(always)]
    pub fn swreq31(&mut self) -> Swreq31W<GswrSpec> {
        Swreq31W::new(self, 31)
    }
}
