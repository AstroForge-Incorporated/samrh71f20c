...
#[doc = "Field `SWF24` writer - XDMAC Channel 24 Software Flush Request Bit"]
pub type Swf24W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWF25` writer - XDMAC Channel 25 Software Flush Request Bit"]
pub type Swf25W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWF26` writer - XDMAC Channel 26 Software Flush Request Bit"]
pub type Swf26W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWF27` writer - XDMAC Channel 27 Software Flush Request Bit"]
pub type Swf27W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWF28` writer - XDMAC Channel 28 Software Flush Request Bit"]
pub type Swf28W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWF29` writer - XDMAC Channel 29 Software Flush Request Bit"]
pub type Swf29W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWF30` writer - XDMAC Channel 30 Software Flush Request Bit"]
pub type Swf30W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SWF31` writer - XDMAC Channel 31 Software Flush Request Bit"]
pub type Swf31W<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[doc = "Bit 24 - XDMAC Channel 24 Software Flush Request Bit"]
    #[inline(always)]
    pub fn swf24(&mut self) -> Swf24W<GswfSpec> {
        Swf24W::new(self, 24)
    }
    #[doc = "Bit 25 - XDMAC Channel 25 Software Flush Request Bit"]
    #[inline(always)]
    pub fn swf25(&mut self) -> Swf25W<GswfSpec> {
        Swf25W::new(self, 25)
    }
    #[doc = "Bit 26 - XDMAC Channel 26 Software Flush Request Bit"]
    #[inline(always)]
    pub fn swf26(&mut self) -> Swf26W<GswfSpec> {
        Swf26W::new(self, 26)
    }
    #[doc = "Bit 27 - XDMAC Channel 27 Software Flush Request Bit"]
    #[inline(always)]
    pub fn swf27(&mut self) -> Swf27W<GswfSpec> {
        Swf27W::new(self, 27)
    }
    #[doc = "Bit 28 - XDMAC Channel 28 Software Flush Request Bit"]
    #[inline(always)]
    pub fn swf28(&mut self) -> Swf28W<GswfSpec> {
        Swf28W::new(self, 28)
    }
    #[doc = "Bit 29 - XDMAC Channel 29 Software Flush Request Bit"]
    #[inline(always)]
    pub fn swf29(&mut self) -> Swf29W<GswfSpec> {
        Swf29W::new(self, 29)
    }
    #[doc = "Bit 30 - XDMAC Channel 30 Software Flush Request Bit"]
    #[inline(always)]
    pub fn swf30(&mut self) -> Swf30W<GswfSpec> {
        Swf30W::new(self, 30)
    }
    #[doc = "Bit 31 - XDMAC Channel 31 Software Flush Request Bit"]
    #[inline(always)]
    pub fn swf31(&mut self) -> Swf31W<GswfSpec> {
        Swf31W::new(self, 31)
    }
}
