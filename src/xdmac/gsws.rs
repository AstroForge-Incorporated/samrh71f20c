...
#[doc = "Field `SWRS24` reader - XDMAC Channel 24 Software Request Status Bit"]
pub type Swrs24R = crate::BitReader;
#[doc = "Field `SWRS25` reader - XDMAC Channel 25 Software Request Status Bit"]
pub type Swrs25R = crate::BitReader;
#[doc = "Field `SWRS26` reader - XDMAC Channel 26 Software Request Status Bit"]
pub type Swrs26R = crate::BitReader;
#[doc = "Field `SWRS27` reader - XDMAC Channel 27 Software Request Status Bit"]
pub type Swrs27R = crate::BitReader;
#[doc = "Field `SWRS28` reader - XDMAC Channel 28 Software Request Status Bit"]
pub type Swrs28R = crate::BitReader;
#[doc = "Field `SWRS29` reader - XDMAC Channel 29 Software Request Status Bit"]
pub type Swrs29R = crate::BitReader;
#[doc = "Field `SWRS30` reader - XDMAC Channel 30 Software Request Status Bit"]
pub type Swrs30R = crate::BitReader;
#[doc = "Field `SWRS31` reader - XDMAC Channel 31 Software Request Status Bit"]
pub type Swrs31R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 24 - XDMAC Channel 24 Software Request Status Bit"]
    #[inline(always)]
    pub fn swrs24(&self) -> Swrs24R {
        Swrs24R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - XDMAC Channel 25 Software Request Status Bit"]
    #[inline(always)]
    pub fn swrs25(&self) -> Swrs25R {
        Swrs25R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - XDMAC Channel 26 Software Request Status Bit"]
    #[inline(always)]
    pub fn swrs26(&self) -> Swrs26R {
        Swrs26R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - XDMAC Channel 27 Software Request Status Bit"]
    #[inline(always)]
    pub fn swrs27(&self) -> Swrs27R {
        Swrs27R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - XDMAC Channel 28 Software Request Status Bit"]
    #[inline(always)]
    pub fn swrs28(&self) -> Swrs28R {
        Swrs28R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - XDMAC Channel 29 Software Request Status Bit"]
    #[inline(always)]
    pub fn swrs29(&self) -> Swrs29R {
        Swrs29R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - XDMAC Channel 30 Software Request Status Bit"]
    #[inline(always)]
    pub fn swrs30(&self) -> Swrs30R {
        Swrs30R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - XDMAC Channel 31 Software Request Status Bit"]
    #[inline(always)]
    pub fn swrs31(&self) -> Swrs31R {
        Swrs31R::new(((self.bits >> 31) & 1) != 0)
    }
}
