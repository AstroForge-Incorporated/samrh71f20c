...
#[doc = "Field `RWR24` writer - XDMAC Channel 24 Read Write Resume Bit"]
pub type Rwr24W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWR25` writer - XDMAC Channel 25 Read Write Resume Bit"]
pub type Rwr25W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWR26` writer - XDMAC Channel 26 Read Write Resume Bit"]
pub type Rwr26W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWR27` writer - XDMAC Channel 27 Read Write Resume Bit"]
pub type Rwr27W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWR28` writer - XDMAC Channel 28 Read Write Resume Bit"]
pub type Rwr28W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWR29` writer - XDMAC Channel 29 Read Write Resume Bit"]
pub type Rwr29W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWR30` writer - XDMAC Channel 30 Read Write Resume Bit"]
pub type Rwr30W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWR31` writer - XDMAC Channel 31 Read Write Resume Bit"]
pub type Rwr31W<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[doc = "Bit 24 - XDMAC Channel 24 Read Write Resume Bit"]
    #[inline(always)]
    pub fn rwr24(&mut self) -> Rwr24W<GrwrSpec> {
        Rwr24W::new(self, 24)
    }
    #[doc = "Bit 25 - XDMAC Channel 25 Read Write Resume Bit"]
    #[inline(always)]
    pub fn rwr25(&mut self) -> Rwr25W<GrwrSpec> {
        Rwr25W::new(self, 25)
    }
    #[doc = "Bit 26 - XDMAC Channel 26 Read Write Resume Bit"]
    #[inline(always)]
    pub fn rwr26(&mut self) -> Rwr26W<GrwrSpec> {
        Rwr26W::new(self, 26)
    }
    #[doc = "Bit 27 - XDMAC Channel 27 Read Write Resume Bit"]
    #[inline(always)]
    pub fn rwr27(&mut self) -> Rwr27W<GrwrSpec> {
        Rwr27W::new(self, 27)
    }
    #[doc = "Bit 28 - XDMAC Channel 28 Read Write Resume Bit"]
    #[inline(always)]
    pub fn rwr28(&mut self) -> Rwr28W<GrwrSpec> {
        Rwr28W::new(self, 28)
    }
    #[doc = "Bit 29 - XDMAC Channel 29 Read Write Resume Bit"]
    #[inline(always)]
    pub fn rwr29(&mut self) -> Rwr29W<GrwrSpec> {
        Rwr29W::new(self, 29)
    }
    #[doc = "Bit 30 - XDMAC Channel 30 Read Write Resume Bit"]
    #[inline(always)]
    pub fn rwr30(&mut self) -> Rwr30W<GrwrSpec> {
        Rwr30W::new(self, 30)
    }
    #[doc = "Bit 31 - XDMAC Channel 31 Read Write Resume Bit"]
    #[inline(always)]
    pub fn rwr31(&mut self) -> Rwr31W<GrwrSpec> {
        Rwr31W::new(self, 31)
    }
}
