...
#[doc = "Field `ST24` reader - XDMAC Channel 24 Status Bit"]
pub type St24R = crate::BitReader;
#[doc = "Field `ST25` reader - XDMAC Channel 25 Status Bit"]
pub type St25R = crate::BitReader;
#[doc = "Field `ST26` reader - XDMAC Channel 26 Status Bit"]
pub type St26R = crate::BitReader;
#[doc = "Field `ST27` reader - XDMAC Channel 27 Status Bit"]
pub type St27R = crate::BitReader;
#[doc = "Field `ST28` reader - XDMAC Channel 28 Status Bit"]
pub type St28R = crate::BitReader;
#[doc = "Field `ST29` reader - XDMAC Channel 29 Status Bit"]
pub type St29R = crate::BitReader;
#[doc = "Field `ST30` reader - XDMAC Channel 30 Status Bit"]
pub type St30R = crate::BitReader;
#[doc = "Field `ST31` reader - XDMAC Channel 31 Status Bit"]
pub type St31R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 24 - XDMAC Channel 24 Status Bit"]
    #[inline(always)]
    pub fn st24(&self) -> St24R {
        St24R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - XDMAC Channel 25 Status Bit"]
    #[inline(always)]
    pub fn st25(&self) -> St25R {
        St25R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - XDMAC Channel 26 Status Bit"]
    #[inline(always)]
    pub fn st26(&self) -> St26R {
        St26R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - XDMAC Channel 27 Status Bit"]
    #[inline(always)]
    pub fn st27(&self) -> St27R {
        St27R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - XDMAC Channel 28 Status Bit"]
    #[inline(always)]
    pub fn st28(&self) -> St28R {
        St28R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - XDMAC Channel 29 Status Bit"]
    #[inline(always)]
    pub fn st29(&self) -> St29R {
        St29R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - XDMAC Channel 30 Status Bit"]
    #[inline(always)]
    pub fn st30(&self) -> St30R {
        St30R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - XDMAC Channel 31 Status Bit"]
    #[inline(always)]
    pub fn st31(&self) -> St31R {
        St31R::new(((self.bits >> 31) & 1) != 0)
    }
}
