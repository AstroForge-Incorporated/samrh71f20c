...
#[doc = "Field `RWS24` writer - XDMAC Channel 24 Read Write Suspend Bit"]
pub type Rws24W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWS25` writer - XDMAC Channel 25 Read Write Suspend Bit"]
pub type Rws25W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWS26` writer - XDMAC Channel 26 Read Write Suspend Bit"]
pub type Rws26W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWS27` writer - XDMAC Channel 27 Read Write Suspend Bit"]
pub type Rws27W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWS28` writer - XDMAC Channel 28 Read Write Suspend Bit"]
pub type Rws28W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWS29` writer - XDMAC Channel 29 Read Write Suspend Bit"]
pub type Rws29W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWS30` writer - XDMAC Channel 30 Read Write Suspend Bit"]
pub type Rws30W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RWS31` writer - XDMAC Channel 31 Read Write Suspend Bit"]
pub type Rws31W<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[doc = "Bit 24 - XDMAC Channel 24 Read Write Suspend Bit"]
    #[inline(always)]
    pub fn rws24(&mut self) -> Rws24W<GrwsSpec> {
        Rws24W::new(self, 24)
    }
    #[doc = "Bit 25 - XDMAC Channel 25 Read Write Suspend Bit"]
    #[inline(always)]
    pub fn rws25(&mut self) -> Rws25W<GrwsSpec> {
        Rws25W::new(self, 25)
    }
    #[doc = "Bit 26 - XDMAC Channel 26 Read Write Suspend Bit"]
    #[inline(always)]
    pub fn rws26(&mut self) -> Rws26W<GrwsSpec> {
        Rws26W::new(self, 26)
    }
    #[doc = "Bit 27 - XDMAC Channel 27 Read Write Suspend Bit"]
    #[inline(always)]
    pub fn rws27(&mut self) -> Rws27W<GrwsSpec> {
        Rws27W::new(self, 27)
    }
    #[doc = "Bit 28 - XDMAC Channel 28 Read Write Suspend Bit"]
    #[inline(always)]
    pub fn rws28(&mut self) -> Rws28W<GrwsSpec> {
        Rws28W::new(self, 28)
    }
    #[doc = "Bit 29 - XDMAC Channel 29 Read Write Suspend Bit"]
    #[inline(always)]
    pub fn rws29(&mut self) -> Rws29W<GrwsSpec> {
        Rws29W::new(self, 29)
    }
    #[doc = "Bit 30 - XDMAC Channel 30 Read Write Suspend Bit"]
    #[inline(always)]
    pub fn rws30(&mut self) -> Rws30W<GrwsSpec> {
        Rws30W::new(self, 30)
    }
    #[doc = "Bit 31 - XDMAC Channel 31 Read Write Suspend Bit"]
    #[inline(always)]
    pub fn rws31(&mut self) -> Rws31W<GrwsSpec> {
        Rws31W::new(self, 31)
    }
}
