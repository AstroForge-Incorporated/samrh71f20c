...
#[doc = "Field `IM24` reader - XDMAC Channel 24 Interrupt Mask Bit"]
pub type Im24R = crate::BitReader;
#[doc = "Field `IM25` reader - XDMAC Channel 25 Interrupt Mask Bit"]
pub type Im25R = crate::BitReader;
#[doc = "Field `IM26` reader - XDMAC Channel 26 Interrupt Mask Bit"]
pub type Im26R = crate::BitReader;
#[doc = "Field `IM27` reader - XDMAC Channel 27 Interrupt Mask Bit"]
pub type Im27R = crate::BitReader;
#[doc = "Field `IM28` reader - XDMAC Channel 28 Interrupt Mask Bit"]
pub type Im28R = crate::BitReader;
#[doc = "Field `IM29` reader - XDMAC Channel 29 Interrupt Mask Bit"]
pub type Im29R = crate::BitReader;
#[doc = "Field `IM30` reader - XDMAC Channel 30 Interrupt Mask Bit"]
pub type Im30R = crate::BitReader;
#[doc = "Field `IM31` reader - XDMAC Channel 31 Interrupt Mask Bit"]
pub type Im31R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 24 - XDMAC Channel 24 Interrupt Mask Bit"]
    #[inline(always)]
    pub fn im24(&self) -> Im24R {
        Im24R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - XDMAC Channel 25 Interrupt Mask Bit"]
    #[inline(always)]
    pub fn im25(&self) -> Im25R {
        Im25R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - XDMAC Channel 26 Interrupt Mask Bit"]
    #[inline(always)]
    pub fn im26(&self) -> Im26R {
        Im26R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - XDMAC Channel 27 Interrupt Mask Bit"]
    #[inline(always)]
    pub fn im27(&self) -> Im27R {
        Im27R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - XDMAC Channel 28 Interrupt Mask Bit"]
    #[inline(always)]
    pub fn im28(&self) -> Im28R {
        Im28R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - XDMAC Channel 29 Interrupt Mask Bit"]
    #[inline(always)]
    pub fn im29(&self) -> Im29R {
        Im29R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - XDMAC Channel 30 Interrupt Mask Bit"]
    #[inline(always)]
    pub fn im30(&self) -> Im30R {
        Im30R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - XDMAC Channel 31 Interrupt Mask Bit"]
    #[inline(always)]
