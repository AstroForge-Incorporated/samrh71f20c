...
pub type R = crate::R<Etrg2Spec>;
#[doc = "Register `ETRG2` writer"]
pub type W = crate::W<Etrg2Spec>;
...
impl W {
    #[doc = "Bits 0:23 - Maximum Counter value"]
    #[inline(always)]
    pub fn maxcnt(&mut self) -> MaxcntW<Etrg2Spec> {
        MaxcntW::new(self, 0)
    }
    #[doc = "Bits 24:25 - External Trigger Mode"]
    #[inline(always)]
    pub fn trgmode(&mut self) -> TrgmodeW<Etrg2Spec> {
        TrgmodeW::new(self, 24)
    }
    #[doc = "Bit 28 - Edge Selection"]
    #[inline(always)]
    pub fn trgedge(&mut self) -> TrgedgeW<Etrg2Spec> {
        TrgedgeW::new(self, 28)
    }
    #[doc = "Bit 29 - Filtered input"]
    #[inline(always)]
    pub fn trgfilt(&mut self) -> TrgfiltW<Etrg2Spec> {
        TrgfiltW::new(self, 29)
    }
    #[doc = "Bit 30 - Trigger Source"]
    #[inline(always)]
    pub fn trgsrc(&mut self) -> TrgsrcW<Etrg2Spec> {
        TrgsrcW::new(self, 30)
    }
    #[doc = "Bit 31 - Recoverable Fault Enable"]
    #[inline(always)]
    pub fn rfen(&mut self) -> RfenW<Etrg2Spec> {
        RfenW::new(self, 31)
    }
}
#[doc = "PWM External Trigger Register (trg_num = 2)\n\nYou can [`read`](crate::Reg::read) this register and get [`etrg2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`etrg2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Etrg2Spec;
impl crate::RegisterSpec for Etrg2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`etrg2::R`](R) reader structure"]
impl crate::Readable for Etrg2Spec {}
#[doc = "`write(|w| ..)` method takes [`etrg2::W`](W) writer structure"]
impl crate::Writable for Etrg2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ETRG2 to value 0"]
impl crate::Resettable for Etrg2Spec {}
