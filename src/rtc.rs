...
impl RegisterBlock {
    ...
    #[doc = "0xd0 - Milliseconds Register"]
    #[inline(always)]
...
#[doc = "Status Register"]
pub mod sr;
#[doc = "SCCR (w) register accessor: Status Clear Command Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sccr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sccr`] module"]
#[doc(alias = "SCCR")]
