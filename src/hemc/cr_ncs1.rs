#[doc = "Register `CR_NCS1` reader"]
pub type R = crate::R<CrNcs1Spec>;
#[doc = "Register `CR_NCS1` writer"]
pub type W = crate::W<CrNcs1Spec>;
...
impl W {
    #[doc = "Bit 0 - fixed to 0"]
    #[inline(always)]
    pub fn zero(&mut self) -> ZeroW<CrNcs1Spec> {
        ZeroW::new(self, 0)
    }
    #[doc = "Bits 1:5 - Bank Size"]
    #[inline(always)]
    pub fn banksize(&mut self) -> BanksizeW<CrNcs1Spec> {
        BanksizeW::new(self, 1)
    }
    #[doc = "Bit 6 - type of memory used"]
    #[inline(always)]
    pub fn type_(&mut self) -> TypeW<CrNcs1Spec> {
        TypeW::new(self, 6)
    }
    #[doc = "Bits 7:24 - relative base address of NCS area"]
    #[inline(always)]
    pub fn addbase(&mut self) -> AddbaseW<CrNcs1Spec> {
        AddbaseW::new(self, 7)
    }
    #[doc = "Bit 30 - ECC Protection Enable"]
    #[inline(always)]
    pub fn ecc_enable(&mut self) -> EccEnableW<CrNcs1Spec> {
        EccEnableW::new(self, 30)
    }
    #[doc = "Bit 31 - BCH ECC Enable"]
    #[inline(always)]
    pub fn ecc12_enable(&mut self) -> Ecc12EnableW<CrNcs1Spec> {
        Ecc12EnableW::new(self, 31)
    }
}
#[doc = "HEMC Control Register NCS 1\n\nYou can [`read`](crate::Reg::read) this register and get [`cr_ncs1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cr_ncs1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CrNcs1Spec;
impl crate::RegisterSpec for CrNcs1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cr_ncs1::R`](R) reader structure"]
impl crate::Readable for CrNcs1Spec {}
#[doc = "`write(|w| ..)` method takes [`cr_ncs1::W`](W) writer structure"]
impl crate::Writable for CrNcs1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CR_NCS1 to value 0"]
impl crate::Resettable for CrNcs1Spec {}
