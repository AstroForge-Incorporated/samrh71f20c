...
impl W {
    ...
    #[inline(always)]
    pub fn outofrange(&mut self) -> OutofrangeW<IerSpec> {
        OutofrangeW::new(self, 1)
    }
    #[doc = "Bit 2 - read access error"]
    #[inline(always)]
    pub fn rderroraccess(&mut self) -> RderroraccessW<IerSpec> {
        RderroraccessW::new(self, 2)
    }
    #[doc = "Bit 3 - write access error"]
    #[inline(always)]
    pub fn wrerroraccess(&mut self) -> WrerroraccessW<IerSpec> {
        WrerroraccessW::new(self, 3)
    }
    #[doc = "Bit 4 - user or superuser access error"]
    #[inline(always)]
    pub fn usererroraccess(&mut self) -> UsererroraccessW<IerSpec> {
