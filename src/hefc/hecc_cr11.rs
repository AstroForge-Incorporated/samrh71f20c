#[doc = "Register `HECC_CR11` reader"]
pub type R = crate::R<HeccCr11Spec>;
#[doc = "Register `HECC_CR11` writer"]
pub type W = crate::W<HeccCr11Spec>;
...
impl W {
    #[doc = "Bit 0 - ECC protection enable"]
    #[inline(always)]
    pub fn enable(&mut self) -> EnableW<HeccCr11Spec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 1 - test mode of ECC protection - read mode"]
    #[inline(always)]
    pub fn test_mode_rd(&mut self) -> TestModeRdW<HeccCr11Spec> {
        TestModeRdW::new(self, 1)
    }
    #[doc = "Bit 2 - test mode of ECC protection - write mode"]
    #[inline(always)]
    pub fn test_mode_wr(&mut self) -> TestModeWrW<HeccCr11Spec> {
        TestModeWrW::new(self, 2)
    }
    #[doc = "Bit 4 - reset the fixable error counter"]
    #[inline(always)]
    pub fn rst_fix_cpt(&mut self) -> RstFixCptW<HeccCr11Spec> {
        RstFixCptW::new(self, 4)
    }
    #[doc = "Bit 5 - reset the un-fixable error counter"]
    #[inline(always)]
    pub fn rst_nofix_cpt(&mut self) -> RstNofixCptW<HeccCr11Spec> {
        RstNofixCptW::new(self, 5)
    }
    #[doc = "Bit 6 - BCH ECC enable"]
    #[inline(always)]
    pub fn ecc12_enable(&mut self) -> Ecc12EnableW<HeccCr11Spec> {
        Ecc12EnableW::new(self, 6)
    }
}
#[doc = "HECC Control Register ChannelNumbers (ChannelNumbers = 0) 11\n\nYou can [`read`](crate::Reg::read) this register and get [`hecc_cr11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hecc_cr11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HeccCr11Spec;
impl crate::RegisterSpec for HeccCr11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hecc_cr11::R`](R) reader structure"]
impl crate::Readable for HeccCr11Spec {}
#[doc = "`write(|w| ..)` method takes [`hecc_cr11::W`](W) writer structure"]
impl crate::Writable for HeccCr11Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HECC_CR11 to value 0"]
impl crate::Resettable for HeccCr11Spec {}
