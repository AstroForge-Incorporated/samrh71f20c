#[doc = "Register `LINK1_DISTACKPI_RM` reader"]
pub type R = crate::R<Link1DistackpiRmSpec>;
...
#[doc = "SpW Link 1 Distributed Interrupt Acknowledge Pending Read Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link1_distackpi_rm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link1DistackpiRmSpec;
impl crate::RegisterSpec for Link1DistackpiRmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link1_distackpi_rm::R`](R) reader structure"]
impl crate::Readable for Link1DistackpiRmSpec {}
#[doc = "`reset()` method sets LINK1_DISTACKPI_RM to value 0"]
impl crate::Resettable for Link1DistackpiRmSpec {}
