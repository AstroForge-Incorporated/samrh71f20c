#[doc = "Register `TCH_PI_R` reader"]
pub type R = crate::R<TchPiRSpec>;
...
#[doc = "SpW Tch Pending Read Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`tch_pi_r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TchPiRSpec;
impl crate::RegisterSpec for TchPiRSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tch_pi_r::R`](R) reader structure"]
impl crate::Readable for TchPiRSpec {}
#[doc = "`reset()` method sets TCH_PI_R to value 0"]
impl crate::Resettable for TchPiRSpec {}
