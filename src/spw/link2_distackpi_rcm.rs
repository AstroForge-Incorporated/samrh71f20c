#[doc = "Register `LINK2_DISTACKPI_RCM` reader"]
pub type R = crate::R<Link2DistackpiRcmSpec>;
...
#[doc = "SpW Link 2 Distributed Interrupt Acknowledge Pending Read and Clear Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_distackpi_rcm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2DistackpiRcmSpec;
impl crate::RegisterSpec for Link2DistackpiRcmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_distackpi_rcm::R`](R) reader structure"]
impl crate::Readable for Link2DistackpiRcmSpec {}
#[doc = "`reset()` method sets LINK2_DISTACKPI_RCM to value 0"]
impl crate::Resettable for Link2DistackpiRcmSpec {}
