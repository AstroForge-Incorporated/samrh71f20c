#[doc = "Register `PKTTX1_PI_RM` reader"]
pub type R = crate::R<Pkttx1PiRmSpec>;
...
#[doc = "PktTx Pending Read Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`pkttx1_pi_rm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pkttx1PiRmSpec;
impl crate::RegisterSpec for Pkttx1PiRmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pkttx1_pi_rm::R`](R) reader structure"]
impl crate::Readable for Pkttx1PiRmSpec {}
#[doc = "`reset()` method sets PKTTX1_PI_RM to value 0"]
impl crate::Resettable for Pkttx1PiRmSpec {}
