#[doc = "Register `LINK2_DISTACKPI_R` reader"]
pub type R = crate::R<Link2DistackpiRSpec>;
...
#[doc = "SpW Link 2 Distributed Interrupt Acknowledge Pending Read Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_distackpi_r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2DistackpiRSpec;
impl crate::RegisterSpec for Link2DistackpiRSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_distackpi_r::R`](R) reader structure"]
impl crate::Readable for Link2DistackpiRSpec {}
#[doc = "`reset()` method sets LINK2_DISTACKPI_R to value 0"]
impl crate::Resettable for Link2DistackpiRSpec {}
