#[doc = "Register `LINK2_STATUS` reader"]
pub type R = crate::R<Link2StatusSpec>;
#[doc = "LinkState\n\nValue on reset: 0"]
...
#[doc = "SpW Link 2 Status\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_status::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2StatusSpec;
impl crate::RegisterSpec for Link2StatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_status::R`](R) reader structure"]
impl crate::Readable for Link2StatusSpec {}
#[doc = "`reset()` method sets LINK2_STATUS to value 0"]
impl crate::Resettable for Link2StatusSpec {}
