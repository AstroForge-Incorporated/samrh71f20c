#[doc = "Register `LINK2_PI_RCM` reader"]
pub type R = crate::R<Link2PiRcmSpec>;
...
#[doc = "SpW Link 2 Pending Read and Clear Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_pi_rcm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2PiRcmSpec;
impl crate::RegisterSpec for Link2PiRcmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_pi_rcm::R`](R) reader structure"]
impl crate::Readable for Link2PiRcmSpec {}
#[doc = "`reset()` method sets LINK2_PI_RCM to value 0"]
impl crate::Resettable for Link2PiRcmSpec {}
