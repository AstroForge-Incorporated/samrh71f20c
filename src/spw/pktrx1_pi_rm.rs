#[doc = "Register `PKTRX1_PI_RM` reader"]
pub type R = crate::R<Pktrx1PiRmSpec>;
...
#[doc = "PktRx Pending Read Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`pktrx1_pi_rm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pktrx1PiRmSpec;
impl crate::RegisterSpec for Pktrx1PiRmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pktrx1_pi_rm::R`](R) reader structure"]
impl crate::Readable for Pktrx1PiRmSpec {}
#[doc = "`reset()` method sets PKTRX1_PI_RM to value 0"]
impl crate::Resettable for Pktrx1PiRmSpec {}
