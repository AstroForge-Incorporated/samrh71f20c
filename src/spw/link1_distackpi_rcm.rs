#[doc = "Register `LINK1_DISTACKPI_RCM` reader"]
pub type R = crate::R<Link1DistackpiRcmSpec>;
...
#[doc = "SpW Link 1 Distributed Interrupt Acknowledge Pending Read and Clear Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link1_distackpi_rcm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link1DistackpiRcmSpec;
impl crate::RegisterSpec for Link1DistackpiRcmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link1_distackpi_rcm::R`](R) reader structure"]
impl crate::Readable for Link1DistackpiRcmSpec {}
#[doc = "`reset()` method sets LINK1_DISTACKPI_RCM to value 0"]
impl crate::Resettable for Link1DistackpiRcmSpec {}
