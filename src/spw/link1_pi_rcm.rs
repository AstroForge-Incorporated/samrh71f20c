#[doc = "Register `LINK1_PI_RCM` reader"]
pub type R = crate::R<Link1PiRcmSpec>;
...
#[doc = "SpW Link 1 Pending Read and Clear Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link1_pi_rcm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link1PiRcmSpec;
impl crate::RegisterSpec for Link1PiRcmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link1_pi_rcm::R`](R) reader structure"]
impl crate::Readable for Link1PiRcmSpec {}
#[doc = "`reset()` method sets LINK1_PI_RCM to value 0"]
impl crate::Resettable for Link1PiRcmSpec {}
