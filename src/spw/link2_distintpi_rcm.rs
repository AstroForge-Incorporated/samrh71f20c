#[doc = "Register `LINK2_DISTINTPI_RCM` reader"]
pub type R = crate::R<Link2DistintpiRcmSpec>;
...
#[doc = "SpW Link 2 Distributed Interrupt Pending Read and Clear Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_distintpi_rcm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2DistintpiRcmSpec;
impl crate::RegisterSpec for Link2DistintpiRcmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_distintpi_rcm::R`](R) reader structure"]
impl crate::Readable for Link2DistintpiRcmSpec {}
#[doc = "`reset()` method sets LINK2_DISTINTPI_RCM to value 0"]
impl crate::Resettable for Link2DistintpiRcmSpec {}
