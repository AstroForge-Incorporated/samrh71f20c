#[doc = "Register `LINK1_DISTINTPI_RCM` reader"]
pub type R = crate::R<Link1DistintpiRcmSpec>;
...
#[doc = "SpW Link 1 Distributed Interrupt Pending Read and Clear Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link1_distintpi_rcm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link1DistintpiRcmSpec;
impl crate::RegisterSpec for Link1DistintpiRcmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link1_distintpi_rcm::R`](R) reader structure"]
impl crate::Readable for Link1DistintpiRcmSpec {}
#[doc = "`reset()` method sets LINK1_DISTINTPI_RCM to value 0"]
impl crate::Resettable for Link1DistintpiRcmSpec {}
