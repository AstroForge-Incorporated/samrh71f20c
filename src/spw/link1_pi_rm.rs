#[doc = "Register `LINK1_PI_RM` reader"]
pub type R = crate::R<Link1PiRmSpec>;
...
#[doc = "SpW Link 1 Pending Read Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link1_pi_rm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link1PiRmSpec;
impl crate::RegisterSpec for Link1PiRmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link1_pi_rm::R`](R) reader structure"]
impl crate::Readable for Link1PiRmSpec {}
#[doc = "`reset()` method sets LINK1_PI_RM to value 0"]
impl crate::Resettable for Link1PiRmSpec {}
