#[doc = "Register `LINK2_DISTACKPI_RM` reader"]
pub type R = crate::R<Link2DistackpiRmSpec>;
...
#[doc = "SpW Link 2 Distributed Interrupt Acknowledge Pending Read Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_distackpi_rm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2DistackpiRmSpec;
impl crate::RegisterSpec for Link2DistackpiRmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_distackpi_rm::R`](R) reader structure"]
impl crate::Readable for Link2DistackpiRmSpec {}
#[doc = "`reset()` method sets LINK2_DISTACKPI_RM to value 0"]
impl crate::Resettable for Link2DistackpiRmSpec {}
