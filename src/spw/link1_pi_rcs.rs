#[doc = "Register `LINK1_PI_RCS` reader"]
pub type R = crate::R<Link1PiRcsSpec>;
#[doc = "Register `LINK1_PI_RCS` writer"]
pub type W = crate::W<Link1PiRcsSpec>;
...
impl W {
    #[doc = "Bit 0 - DisErr"]
    #[inline(always)]
    pub fn diserr(&mut self) -> DiserrW<Link1PiRcsSpec> {
        DiserrW::new(self, 0)
    }
    #[doc = "Bit 1 - ParErr"]
    #[inline(always)]
    pub fn parerr(&mut self) -> ParerrW<Link1PiRcsSpec> {
        ParerrW::new(self, 1)
    }
    #[doc = "Bit 2 - ESCErr"]
    #[inline(always)]
    pub fn escerr(&mut self) -> EscerrW<Link1PiRcsSpec> {
        EscerrW::new(self, 2)
    }
    #[doc = "Bit 3 - CrErr"]
    #[inline(always)]
    pub fn crerr(&mut self) -> CrerrW<Link1PiRcsSpec> {
        CrerrW::new(self, 3)
    }
    #[doc = "Bit 4 - LinkAbort"]
    #[inline(always)]
    pub fn linkabort(&mut self) -> LinkabortW<Link1PiRcsSpec> {
        LinkabortW::new(self, 4)
    }
    #[doc = "Bit 5 - EEP transmitted"]
    #[inline(always)]
    pub fn eeptrans(&mut self) -> EeptransW<Link1PiRcsSpec> {
        EeptransW::new(self, 5)
    }
    #[doc = "Bit 6 - EEP received"]
    #[inline(always)]
    pub fn eeprec(&mut self) -> EeprecW<Link1PiRcsSpec> {
        EeprecW::new(self, 6)
    }
    #[doc = "Bit 7 - Discard"]
    #[inline(always)]
    pub fn discard(&mut self) -> DiscardW<Link1PiRcsSpec> {
        DiscardW::new(self, 7)
    }
    #[doc = "Bit 8 - Escape Event 2"]
    #[inline(always)]
    pub fn escevent2(&mut self) -> Escevent2W<Link1PiRcsSpec> {
        Escevent2W::new(self, 8)
    }
    #[doc = "Bit 9 - Escape Event 1"]
    #[inline(always)]
    pub fn escevent1(&mut self) -> Escevent1W<Link1PiRcsSpec> {
        Escevent1W::new(self, 9)
    }
}
#[doc = "SpW Link 1 Pending Read, Clear and Enabed Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link1_pi_rcs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`link1_pi_rcs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link1PiRcsSpec;
impl crate::RegisterSpec for Link1PiRcsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link1_pi_rcs::R`](R) reader structure"]
impl crate::Readable for Link1PiRcsSpec {}
#[doc = "`write(|w| ..)` method takes [`link1_pi_rcs::W`](W) writer structure"]
impl crate::Writable for Link1PiRcsSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LINK1_PI_RCS to value 0"]
impl crate::Resettable for Link1PiRcsSpec {}
