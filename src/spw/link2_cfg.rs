#[doc = "Register `LINK2_CFG` reader"]
pub type R = crate::R<Link2CfgSpec>;
#[doc = "Register `LINK2_CFG` writer"]
pub type W = crate::W<Link2CfgSpec>;
#[doc = "Command\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:1 - Command"]
    #[inline(always)]
    pub fn command(&mut self) -> CommandW<Link2CfgSpec> {
        CommandW::new(self, 0)
    }
}
#[doc = "SpW Link 2 Config\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`link2_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2CfgSpec;
impl crate::RegisterSpec for Link2CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_cfg::R`](R) reader structure"]
impl crate::Readable for Link2CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`link2_cfg::W`](W) writer structure"]
impl crate::Writable for Link2CfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LINK2_CFG to value 0"]
impl crate::Resettable for Link2CfgSpec {}
