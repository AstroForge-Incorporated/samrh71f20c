#[doc = "Register `LINK2_PI_R` reader"]
pub type R = crate::R<Link2PiRSpec>;
...
#[doc = "SpW Link 2 Pending Read Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_pi_r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2PiRSpec;
impl crate::RegisterSpec for Link2PiRSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_pi_r::R`](R) reader structure"]
impl crate::Readable for Link2PiRSpec {}
#[doc = "`reset()` method sets LINK2_PI_R to value 0"]
impl crate::Resettable for Link2PiRSpec {}
