#[doc = "Register `LINK2_DISTINTPI_R` reader"]
pub type R = crate::R<Link2DistintpiRSpec>;
...
#[doc = "SpW Link 2 Distributed Interrupt Pending Read Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_distintpi_r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2DistintpiRSpec;
impl crate::RegisterSpec for Link2DistintpiRSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_distintpi_r::R`](R) reader structure"]
impl crate::Readable for Link2DistintpiRSpec {}
#[doc = "`reset()` method sets LINK2_DISTINTPI_R to value 0"]
impl crate::Resettable for Link2DistintpiRSpec {}
