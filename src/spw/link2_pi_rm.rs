#[doc = "Register `LINK2_PI_RM` reader"]
pub type R = crate::R<Link2PiRmSpec>;
...
#[doc = "SpW Link 2 Pending Read Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link2_pi_rm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link2PiRmSpec;
impl crate::RegisterSpec for Link2PiRmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link2_pi_rm::R`](R) reader structure"]
impl crate::Readable for Link2PiRmSpec {}
#[doc = "`reset()` method sets LINK2_PI_RM to value 0"]
impl crate::Resettable for Link2PiRmSpec {}
