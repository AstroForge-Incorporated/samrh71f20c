#[doc = "Register `LINK1_DISTINTPI_RM` reader"]
pub type R = crate::R<Link1DistintpiRmSpec>;
...
#[doc = "SpW Link 1 Distributed Interrupt Pending Read Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link1_distintpi_rm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link1DistintpiRmSpec;
impl crate::RegisterSpec for Link1DistintpiRmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link1_distintpi_rm::R`](R) reader structure"]
impl crate::Readable for Link1DistintpiRmSpec {}
#[doc = "`reset()` method sets LINK1_DISTINTPI_RM to value 0"]
impl crate::Resettable for Link1DistintpiRmSpec {}
