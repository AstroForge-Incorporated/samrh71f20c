#[doc = "Register `RMAP1_STS_RC` reader"]
pub type R = crate::R<Rmap1StsRcSpec>;
#[doc = "Error Code\n\nValue on reset: 0"]
...
#[doc = "SpW RMAP 1 Read and Clear Status\n\nYou can [`read`](crate::Reg::read) this register and get [`rmap1_sts_rc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Rmap1StsRcSpec;
impl crate::RegisterSpec for Rmap1StsRcSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rmap1_sts_rc::R`](R) reader structure"]
impl crate::Readable for Rmap1StsRcSpec {}
#[doc = "`reset()` method sets RMAP1_STS_RC to value 0"]
impl crate::Resettable for Rmap1StsRcSpec {}
