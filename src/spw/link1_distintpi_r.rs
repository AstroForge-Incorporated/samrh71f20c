#[doc = "Register `LINK1_DISTINTPI_R` reader"]
pub type R = crate::R<Link1DistintpiRSpec>;
...
#[doc = "SpW Link 1 Distributed Interrupt Pending Read Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`link1_distintpi_r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Link1DistintpiRSpec;
impl crate::RegisterSpec for Link1DistintpiRSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`link1_distintpi_r::R`](R) reader structure"]
impl crate::Readable for Link1DistintpiRSpec {}
#[doc = "`reset()` method sets LINK1_DISTINTPI_R to value 0"]
impl crate::Resettable for Link1DistintpiRSpec {}
