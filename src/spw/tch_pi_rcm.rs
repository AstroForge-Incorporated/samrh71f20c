#[doc = "Register `TCH_PI_RCM` reader"]
pub type R = crate::R<TchPiRcmSpec>;
...
#[doc = "SpW Tch Pending Read and Clear Masked Interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`tch_pi_rcm::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TchPiRcmSpec;
impl crate::RegisterSpec for TchPiRcmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tch_pi_rcm::R`](R) reader structure"]
impl crate::Readable for TchPiRcmSpec {}
#[doc = "`reset()` method sets TCH_PI_RCM to value 0"]
impl crate::Resettable for TchPiRcmSpec {}
